<x-header>
                  ...
                  checkLocationAndProceed((userLat, userLng) => {
                      ...
                      .then(data => {
                          if (data.success) {
                              ...
                              // Opsional: refresh halaman atau update data presensi hari ini
  ...
  <script>
      ...
      // Modified to pass userLat, userLng to the callback
          ...
          navigator.geolocation.getCurrentPosition(
              position => {
                  ...
                  if (distance <= allowedRadius) {
                      // Jika lokasi valid, panggil callback dengan koordinat pengguna
